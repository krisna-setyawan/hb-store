...
<main class="p-md-3 p-2">
    ...
    <div class="row">
        <div class="col-md-7 mb-5">
            ...
            <form autocomplete="off" class="row mt-0 mb-4" action="<?= site_url() ?>sales-customer/<?= $customer['id'] ?>" method="POST">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form novalidate class="needs-validation" id="form-add-pj" autocomplete="off" action="<?= site_url() ?>sales-customerpj" method="POST">
...
<div class="modal fade" id="modal-add-alamat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form novalidate class="needs-validation" id="form-add-alamat" autocomplete="off" action="<?= site_url() ?>sales-customeralamat" method="POST">
...
<div class="modal fade" id="modal-add-rekening" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form novalidate class="needs-validation" id="form-add-rekening" autocomplete="off" action="<?= site_url() ?>sales-customerrekening" method="POST">
...
<script>
    ...
    function edit_pj(id) {
        $.ajax({
            type: "get",
            url: "<?= site_url() ?>sales-customerpj/" + id + "/edit",
            dataType: "json",
            success: function(response) {
                $('#form-edit-pj').attr('action', '<?= site_url() ?>sales-customerpj/' + id);
    ...
    function confirm_delete_pj(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete_pj').attr('action', '<?= site_url() ?>sales-customerpj/' + id);
    ...
    function confirm_delete_alamat(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete_alamat').attr('action', '<?= site_url() ?>sales-customeralamat/' + id);
    ...
    function confirm_delete_rekening(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete_rekening').attr('action', '<?= site_url() ?>sales-customerrekening/' + id);
