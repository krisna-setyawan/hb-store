...
<main class="p-md-3 p-2">
    ...
    <div class="d-flex mb-0">
        <div class="me-auto mb-1">
            <h3 style="color: #566573;">Data Produk di Ruangan <?= $nama_gudang ?></h3>
        </div>
        <div class="me-2 mb-1">
        ...
        <div class="me-2 mb-1">
            <a class="btn btn-sm btn-outline-danger" href="<?= site_url() ?>warehouse-ruangan/<?= $id_gudang ?>">
...
<script>
    $(document).ready(function() {
        $('#tabel').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?= site_url() ?>warehouse-getdataruanganproduk/<?= $id_gudang ?>',
            order: [],
            columns: [{
                    data: 'no',
                    orderable: false
