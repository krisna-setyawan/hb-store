...
<main class="p-md-3 p-2">
    ...
    <div class="d-flex mb-0">
        <div class="me-auto mb-1">
            <h3 style="color: #566573;">Gudang</h3>
        </div>
        <div class="me-2 mb-1">
        ...
        <div class="mb-1">
            <a class="btn btn-sm btn-outline-secondary" href="<?= site_url() ?>resource-gudang/new">
                <i class="fa-fw fa-solid fa-plus"></i> Tambah Gudang
            </a>
        </div>
    </div>
                ...
                <?php foreach ($gudang as $sp) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            if ($rule || $in_group) { ?>
                                <a title="Edit" class="px-2 py-0 btn btn-sm btn-outline-primary" href="<?= site_url() ?>resource-gudang/<?= $sp['id'] ?>/edit">
...
<script>
    ...
    function confirm_delete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete').attr('action', '<?= site_url() ?>resource-gudang/' + id);
                $('#form_delete').submit();
            }
        })
    }
    ...
    function showModalDetail(id) {
        $.ajax({
            type: 'GET',
            url: '<?= site_url() ?>resource-gudang/' + id,
            dataType: 'json',
