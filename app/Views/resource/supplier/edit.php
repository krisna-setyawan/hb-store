...
<main class="p-md-3 p-2">
    <div class="d-flex mb-0">
        ...
        <div class="me-2 mb-1">
            <a class="btn btn-sm btn-outline-dark" href="<?= site_url() ?>resource-supplier">
    ...
    <div class="row">
        <div class="col-md-6 mt-2 mb-5">
            ...
            <form autocomplete="off" class="mt-1" action="<?= site_url() ?>resource-supplier/<?= $supplier['id'] ?>" method="POST">
                ...
                <div class="text-center">
                    <a class="btn px-5 btn-outline-danger" href="<?= site_url() ?>resource-supplier">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form novalidate class="needs-validation" id="form-add-pj" autocomplete="off" action="<?= site_url() ?>resource-supplierpj" method="POST">
...
<div class="modal fade" id="modal-add-alamat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form novalidate class="needs-validation" id="form-add-alamat" autocomplete="off" action="<?= site_url() ?>resource-supplieralamat" method="POST">
...
<div class="modal fade" id="modal-add-link" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form novalidate class="needs-validation" id="form-add-link" autocomplete="off" action="<?= site_url() ?>resource-supplierlink" method="POST">
...
<div class="modal fade" id="modal-add-cs" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form novalidate class="needs-validation" id="form-add-cs" autocomplete="off" action="<?= site_url() ?>resource-suppliercs" method="POST">
...
<script>
    ...
    function edit_pj(id) {
        $.ajax({
            type: "get",
            url: "<?= site_url() ?>resource-supplierpj/" + id + "/edit",
            dataType: "json",
            success: function(response) {
                $('#form-edit-pj').attr('action', '<?= site_url() ?>resource-supplierpj/' + id);
    ...
    function confirm_delete_pj(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete_pj').attr('action', '<?= site_url() ?>resource-supplierpj/' + id);
    ...
    function confirm_delete_alamat(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete_alamat').attr('action', '<?= site_url() ?>resource-supplieralamat/' + id);
    ...
    function confirm_delete_link(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete_link').attr('action', '<?= site_url() ?>resource-supplierlink/' + id);
    ...
    function edit_cs(id) {
        $.ajax({
            type: "get",
            url: "<?= site_url() ?>resource-suppliercs/" + id + "/edit",
            dataType: "json",
            success: function(res) {
                $('#form-edit-cs').attr('action', '<?= site_url() ?>resource-suppliercs/' + id);
    ...
    function confirm_delete_cs(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete_cs').attr('action', '<?= site_url() ?>resource-suppliercs/' + id);
