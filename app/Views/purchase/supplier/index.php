                ...
                <?php foreach ($supplier as $sp) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            if ($rule || $in_group) { ?>
                                <a title="Edit" class="px-2 py-0 btn btn-sm btn-outline-primary" href="<?= site_url() ?>purchase-supplier/<?= $sp['id'] ?>/edit">
...
<script>
    ...
    function confirm_delete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete').attr('action', '<?= site_url() ?>purchase-supplier/' + id);
                $('#form_delete').submit();
            }
        })
    }
    ...
    function showModalDetail(id) {
        $.ajax({
            type: 'GET',
            url: '<?= site_url() ?>purchase-supplier/' + id,
            dataType: 'json',
