    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body" id="isiShow2">
                ...
                <form autocomplete="off" action="<?= site_url() ?>purchase-tambah_tagihan" method="POST" id="form_tambah_tagihan">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#tabel').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?= site_url() ?>purchase-get_data_pembelian',
            order: [],
            columns: [{
                    data: 'no',
                    orderable: false
    ...
    function showModalDetail(no) {
        $.ajax({
            type: 'GET',
            url: '<?= site_url() ?>purchase-show_data_pembelian/' + no,
            dataType: 'json',
            success: function(res) {
                if (res.data) {
                    $('#isiShow').html(res.data)
                    $('#judulModalShow').html('Detail Pembelian')
    ...
    function showModalTagihan(no) {
        $.ajax({
            type: 'GET',
            url: '<?= site_url() ?>purchase-show_tagihan_pembelian/' + no,
            dataType: 'json',
            success: function(res) {
                if (res.data) {
                    $('#isiShow').html(res.data)
    ...
    function showModalTambahTagihan(id_pembelian, no_pembelian) {
    ...
    function showModalInbound(id_pembelian) {
        $.ajax({
            type: "get",
            url: "<?= site_url() ?>purchase-get_list_inbound_pembelian/" + id_pembelian,
            dataType: "json",
            success: function(response) {
                if (response.data) {
