...
<main class="p-md-3 p-2">
    ...
    <form autocomplete="off" class="row g-3 mt-2" action="<?= site_url() ?>hrm-tambah-file" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control <?= (validation_show_error('tgl_upload')) ? 'is-invalid' : ''; ?>" id="tgl_upload" name="tgl_upload" value="<?= old('tgl_upload'); ?>" autofocus>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="file" class="form-control <?= (validation_show_error('nama_file')) ? 'is-invalid' : ''; ?>" id="nama_file" name="nama_file" value="<?= old('nama_file'); ?>" autofocus>
