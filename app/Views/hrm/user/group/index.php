...
<main class="p-md-3 p-2">
    ...
    <div class="d-flex mb-0">
        <div class="me-auto mb-1">
            <h3 style="color: #566573;">Data <?= $nama_group ?></h3>
        </div>
        <div class="me-2 mb-1">
            <a class="btn btn-sm btn-outline-dark" href="<?= site_url() ?>hrm-user-group-view">
    ...
    function confirm_delete(user_id, group_id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete').attr('action', '<?= site_url() ?>hrm-group-delete/' + user_id + '/' + group_id);
                $('#form_delete').submit();
            }
        })
    }
