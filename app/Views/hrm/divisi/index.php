                ...
                <?php foreach ($divisi as $sp) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a title="List" class="px-2 py-0 btn btn-sm btn-outline-dark" href="<?= site_url() ?>hrm-list/<?= $sp['id'] ?>">
...
<script>
    ...
    function confirm_delete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete').attr('action', '<?= site_url() ?>hrm-divisi/' + id);
                $('#form_delete').submit();
            }
        })
    }
    ...
    function showModalEdit(id) {
        $.ajax({
            type: 'GET',
            url: '<?= site_url() ?>hrm-divisi/' + id + '/edit',
            dataType: 'json',
            success: function(res) {
                if (res.data) {
                    $('#isiModal').html(res.data)
