...
use App\Models\Sales\ProvinsiModel;
...
class Customer extends ResourcePresenter
{
    ...
    public function index()
    {
        ...
        return view('sales/customer/index', $data);
    }
    ...
    public function show($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $json = [
                'data' => view('sales/customer/show', $data),
            ];
    ...
    public function new()
    {
        ...
        return view('sales/customer/add', $data);
    }
    ...
    public function create()
    {
        ...
        if (!$this->validate($validasi)) {
            return redirect()->to('/sales-customer/new')->withInput();
        }
        ...
        return redirect()->to('/sales-customer');
    }
    ...
    public function edit($id = null)
    {
        ...
        return view('sales/customer/edit', $data);
    }
    ...
    public function update($id = null)
    {
        ...
        if (!$this->validate($validasi)) {
            return redirect()->to('/sales-customer/' . $old_customer["id"] . '/edit')->withInput();
        }
